...
# shellcheck disable=SC2034  # EXCLUDE_PATHS wird in modules/bindmounts.sh verwendet
...
export EXCLUDE_VOLUMES EXTRA_PATHS DOCKHAND_ENABLED DOCKHAND_URL DOCKHAND_TOKEN
